module.exports = function (env) {
  const DEV_CONSTANTS = {
    PORT: 2276,
    MONGO_URI:
      "mongodb+srv://findoc_user:nQKMemhPm0N4maIJ@cluster0.kr4lh0f.mongodb.net/findoc_communication",
  ...
  const LOCAL_CONSTANTS = {
    PORT: 2276,
    MONGO_URI:
      "mongodb+srv://findoc_user:nQKMemhPm0N4maIJ@cluster0.kr4lh0f.mongodb.net/findoc_cms",
    NODE_ENV: "development",
  ...
  const PREPROD_CONSTANTS = {
    PORT: 2276,
    MONGO_URI:
      "mongodb://devops:Dev$1234@findoc-preprod-docdb-2024-01-17-13-34-25.cluster-chi2e68wccik.ap-south-1.docdb.amazonaws.com:27017/findoc_cms?authMechanism=DEFAULT&tls=true&authSource=findoc_cms&retryWrites=False",
